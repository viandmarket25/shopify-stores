...
import { FeatureEnabled, FutureFlagOptions, FutureFlags } from '../../future/flags';
...
export type BillingConfigItem<Future extends FutureFlagOptions = FutureFlagOptions> = FeatureEnabled<Future, 'lineItemBilling'> extends true ? BillingConfigOneTimePlan | BillingConfigSubscriptionLineItemPlan : BillingConfigLegacyItem;
/**
...
type BillingRequestOverridesType<Future extends FutureFlagOptions = FutureFlagOptions> = FeatureEnabled<Future, 'lineItemBilling'> extends true ? RequestConfigOverrides & RequestConfigLineItemOverrides : RequestConfigOverrides;
export type BillingRequestParams<Future extends FutureFlagOptions = FutureFlagOptions> = {
    /**
