...
let addCommas = (stringValue) => {
  ...
  if (stringValue.length == 4) {
    ...
    result =
      ...
      "," +
      stringValue.substring(3, stringValue.length);
    ...
    result =
      ...
      "," +
      stringValue.substring(5, stringValue.length);
  } else if (stringValue.length == 8) {
    result =
      stringValue.substring(0, 2) +
      "," +
      stringValue.substring(1, 5) +
      "," +
...
let increaseCartProduct = async () => {
  ...
  $({ countNum: $("#" + appParameters.cartTotalMainId).html() }).animate(
    { countNum: Number($("#" + appParameters.cartTotalMainId).html()) + 1 },
    {
      duration: 300,
      easing: "linear",
      step: function () {
...
let awaitIncreaseCartProductQuantity = (clickedId, targetElement) => {
  $("#" + clickedId).click(function () {
    if (
      buyerCartParameters.productQuantity <
        buyerCartParameters.productStockLeft &&
      canIncreaseCartProduct() == true
    ) {
      buyerCartParameters.productQuantity =
        buyerCartParameters.productQuantity + 1;
      console.log(buyerCartParameters.productQuantityId);
      $("#" + buyerCartParameters.productQuantityId).val(
        buyerCartParameters.productQuantity
      );
    }
  });
...
let awaitAddToCartClick = (clickedId, targetElement) => {
  ...
  $("#" + clickedId).click(function () {
    ...
    try {
      for (
        let i = 0;
        i < Object.keys(buyerCartParameters.productVariationsData).length &&
        foundSource == 0;
        i++
      ) {
        if ("mediaSource" in buyerCartParameters.productVariationsData[i]) {
          if (
            typeof buyerCartParameters.productVariationsData[i][
              "mediaSource"
            ] !== "undefined" &&
            buyerCartParameters.productVariationsData[i]["mediaSource"] != ""
          ) {
            mediaSource =
              buyerCartParameters.productVariationsData[i]["mediaSource"];
            foundSource = 1;
    ...
    let payload = {
      ...
      selectedVariations: JSON.stringify(
        buyerCartParameters.productVariationsData
      ),
...
let awaitVariationSelectionListener = (clickedId, targetElement) => {
  $("#" + clickedId).click(function () {
    ...
    $(
      "#" +
        buyerCartParameters.productVariationUiControl[variationId]["elementId"]
    ).css("box-shadow", "0px 0px 0px 1px #f1f1f1");
    $(
      "#" +
        buyerCartParameters.productVariationUiControl[variationId]["elementId"]
...
let buyerPreviewProduct = async (targetElement, renderData) => {
  ...
  productPreviewContainer.setAttribute(
    "style",
    " width:720px; height:auto; background:#fcfcfc; position:relative; overflow:hidden;   "
  );
  targetElement.appendChild(productPreviewContainer);
  // z-index:11111;
  let productGlobalInformation = elementFunction.divFunction("", "", null);
  let productPreviewActionsContainer = elementFunction.divFunction(
    "",
    "",
    null
  );
  productGlobalInformation.setAttribute(
    "style",
    "width:720px; height:40px; position:relative; box-shadow:0px 0px 0px 1px #f1f1f1;  "
  );
  productPreviewActionsContainer.setAttribute(
    "style",
    "width:720px; height:40px; background:#f1faee; margin-top:4px; position:relative;  "
  );

  let closeProductPreview = elementFunction.divFunction("", "", null);
  closeProductPreview.setAttribute(
    "style",
    " width:40px; height:40px; position:relative;  box-shadow:0px 0px 0px 1px #f1f1f1; margin-right:10px; float:left; cursor:pointer;"
  );
  let closePreviewImage = elementFunction.imgFunction(
    "close-product-detail-preview" + uniqueId,
    "close-product-detail-preview",
    "/shorpi/assets/icons/cancel-icon-button.png"
  );
  closePreviewImage.setAttribute(
    "style",
    "width:24px; height:24px; position:relative; top:8px; "
  );
  ...
  visitShopPreview.setAttribute(
    "style",
    " width:40px; height:40px; position:relative;   margin-right:0px; float:left; cursor:pointer;"
  );
  let visitShopImage = elementFunction.imgFunction(
    "close-product-detail-preview" + uniqueId,
    "close-product-detail-preview",
    "/shorpi/assets/icons/shop-icon.png"
  );
  visitShopImage.setAttribute(
    "style",
    "width:24px; height:24px; position:relative; top:8px; "
  );
  ...
  rightButtonsContainer.setAttribute(
    "style",
    " width:340px; height:40px; position:relative;  margin-right:10px; float:right; cursor:pointer;"
  );
  ...
  shareButtonContainer.setAttribute(
    "style",
    " width:40px; height:40px; position:relative;   margin-right:10px; float:right; cursor:pointer;"
  );
  let shareButtonImage = elementFunction.imgFunction(
    "close-product-detail-preview" + uniqueId,
    "close-product-detail-preview",
    "/shorpi/assets/icons/icons8-share.png"
  );
  shareButtonImage.setAttribute(
    "style",
    "width:20px; height:20px; position:relative; top:10px; "
  );
  shareButtonContainer.appendChild(shareButtonImage);
  // ::::::::: message buttons
  let messageButtonContainer = elementFunction.divFunction("", "", null);
  messageButtonContainer.setAttribute(
    "style",
    " width:40px; height:40px; position:relative; margin-left:4px; margin-right:4px; float:right; cursor:pointer;"
  );
  let messageButtonImage = elementFunction.imgFunction(
    "close-product-detail-preview" + uniqueId,
    "close-product-detail-preview",
    "/shorpi/assets/icons/icons8-speech_bubble.png"
  );
  messageButtonImage.setAttribute(
    "style",
    "width:20px; height:20px; position:relative; top:10px; "
  );
  ...
  qrcodeButtonContainer.setAttribute(
    "style",
    " width:40px; height:40px; position:relative;  margin-right:4px; float:right; cursor:pointer;"
  );
  let qrcodeTarget = elementFunction.divFunction(
    "close-product-detail-preview" + uniqueId,
    "close-product-detail-preview",
    null
  );
  qrcodeTarget.setAttribute(
    "style",
    "width:36px; height:30px; position:relative; border-radius:2px; top:5px; box-shadow:0px 0px 0px 1px #ffd6a5; "
  );
  ...
  let shopTitleContainer = elementFunction.divFunction(
    "cart-shop-title-container" + mainId,
    "cart-shop-title-container",
    null
  );
  shopTitleContainer.setAttribute(
    "style",
    "width:auto; height:40px; float:left;   "
  );
  let shopTitle = elementFunction.divFunction(
    "cart-shop-title-container" + mainId,
    "cart-shop-title-container",
    "Elene Ikrostics"
  );
  shopTitle.setAttribute(
    "style",
    "width:auto; height:30px; float:left; text-align:left; line-height:30px; font-family:Montserrat-SemiBold; cursor:pointer; font-size:12px;  color:#606060; position:relative; top:5px; left:10px;  "
  );
  shopTitleContainer.appendChild(shopTitle);
  productGlobalInformation.appendChild(shopTitleContainer);

  //
  let previewProductDetailsContainer = elementFunction.divFunction(
    "",
    "",
    null
  );
  previewProductDetailsContainer.setAttribute(
    "style",
    "width:720px; height:auto;  padding-bottom:200px; overflow-x:hidden; overflow-y:scroll;"
  );
  ...
  let previewProductSplide = elementFunction.divFunction(
    "preview-product-splide",
    "splide",
    null
  );
  ...
  for (let i = 0; i < renderData.productMedia.length; i++) {
    let avatarContainer = elementFunction.divFunction(
      "",
      "splide__slide",
      null
    );
    avatarContainer.setAttribute("align", "center ");
    previewProductSplide.setAttribute(
      "style",
      "position:relative; left:200px; right:200px;  "
    );
    let avatar = elementFunction.imgFunction(
      "",
      "product-preview-image-data",
      renderData.productMedia[i].MEDIA_SOURCE
    );
    avatarContainer.appendChild(avatar);
    splideList.appendChild(avatarContainer);
  }
  // ::::::image steps indicator image
  let previewProductSplide2 = elementFunction.divFunction(
    "preview-product-splide2",
    "splide",
    null
  );
  ...
  productTitleContainer.setAttribute(
    "style",
    "width:100%; height:auto; margin-top:20px; float:left;  "
  );
  let productTitle = elementFunction.divFunction(
    "",
    "",
    renderData.productAttributes.TITLE
  );
  productTitle.setAttribute("align", "left");
  productTitle.setAttribute(
    "style",
    "width:90%; max-height:300px; position:relative; font-size:13px; font-family:Montserrat-Medium; color:#000000; left:10px;"
  );
  ...
  productDescriptionContainer.setAttribute(
    "style",
    "width:100%; height:auto; margin-top:20px; float:left;  "
  );
  let productDescription = elementFunction.divFunction(
    "",
    "",
    renderData.productAttributes.DESCRIPTION
  );
  productDescription.setAttribute("align", "left");
  productDescription.setAttribute(
    "style",
    "width:90%; max-height:300px; position:relative; font-size:11px; font-family:Montserrat-Regular; color:#404040; left:10px;"
  );
  ...
  productPriceContainer.setAttribute(
    "style",
    "width:100%; height:40px; margin-top:10px; background:#f1faee; line-height:40px; float:left;  "
  );
  ...
  productPrice.setAttribute(
    "style",
    "height:24px; width:140px; float:left; border-radius:10px; font-size:14px; position:relative; left:10px; margin-top:2px; color:#000000; line-height:40px; font-family:Montserrat-Bold; font-size:18px; "
  );
  productPriceContainer.appendChild(productPrice);
  let productCurrency = elementFunction.spanFunction("", "", "$");
  productCurrency.setAttribute(
    "style",
    "font-size:12px; font-family:Montserrat-SemiBold; margin-right:2px;"
  );
  productPrice.appendChild(productCurrency);
  $(productPrice).html(
    $(productPrice).html() + addCommas(renderData.productAttributes.PRICE)
  );
  // :::::: product variations
  let productVariationContainer = elementFunction.divFunction("", "", null);
  productVariationContainer.setAttribute(
    "style",
    "width:100%; max-height:auto; margin-top:20px; float:left; "
  );
  previewProductDetailsContainer.appendChild(productVariationContainer);
  for (let i = 0; i < renderData.productVariations.length; i++) {
    let productVariationTitleContainer = elementFunction.divFunction(
      "",
      "",
      null
    );
    productVariationTitleContainer.setAttribute("align", "left");
    productVariationTitleContainer.setAttribute(
      "style",
      "width:100%; height:30px; margin-top:20px; float:left; "
    );
    let productVariationTitle = elementFunction.divFunction(
      "",
      "",
      renderData.productVariations[i].TITLE
    );
    productVariationTitle.setAttribute("align", "left");
    productVariationTitle.setAttribute(
      "style",
      "width:90%; max-height:300px; position:relative; font-size:14px; font-family:Montserrat-Bold; color:#000000; left:2%;"
    );
    ...
    let productVariationOptionsContainer = elementFunction.divFunction(
      "",
      "",
      null
    );
    productVariationOptionsContainer.setAttribute(
      "style",
      "width:80%; max-height:auto; margin-top:4px; float:left; padding-bottom:10px; color:#404040; "
    );
    ...
    if (renderData.productVariations[i].IS_PRICE_VARIATION == 0) {
      ...
      if (renderData.productVariations[i].VARIATION_TYPE == "text") {
        ...
        for (
          let j = 0;
          j < renderData.productVariations[i]["options"].length;
          j++
        ) {
          // :::::::::: variation options
          if (j == 0) {
            ...
            let cartInfo__title =
              renderData.productVariations[i]["options"][j].TITLE;
            let cartInfo__mediaSource = "";
            cartInfo__mediaSource =
              renderData.productVariations[i]["options"][j].MEDIA_SOURCE !=
                undefined &&
              renderData.productVariations[i]["options"][j].MEDIA_SOURCE != null
                ? (cartInfo__mediaSource =
                    renderData.productVariations[i]["options"][j].MEDIA_SOURCE)
                : (cartInfo__mediaSource = "");
            let cartInfo__masterId =
              renderData.productVariations[i]["options"][j].VARIATION_MASTER_ID;

            let productVariationOptionContainer = elementFunction.divFunction(
              "variation-option-container" + uniqueId + i + j,
              "",
              null
            );
            productVariationOptionContainer.setAttribute(
              "style",
              " min-width:20px; max-width:300px; height:auto; float:left; position:relative; margin:4px; margin-left:10px; border-radius:6px; padding-top:8px; padding-bottom:8px; padding-left:14px; padding-right:14px; cursor:pointer; background:#fcfcfc; box-shadow: 0px 0px 0px 3px #000000;  line-height:30px; font-size:12px;  color:#000000;  "
            );
            ...
            productVariationOptionContainer.setAttribute(
              "data-cartInfo__title",
              cartInfo__title
            );
            productVariationOptionContainer.setAttribute(
              "data-cartInfo__mediaSource",
              cartInfo__mediaSource
            );
            productVariationOptionContainer.setAttribute(
              "data-cartInfo__masterId",
              cartInfo__masterId
            );

            //variation_id
            let variationOptionTitle = elementFunction.divFunction(
              "variation-option" + uniqueId + i + j,
              "",
              renderData.productVariations[i]["options"][j].TITLE
            );
            variationOptionTitle.setAttribute(
              "style",
              "width:auto; height:auto; font-family:Montserrat-Medium; color:#404040; position:relative; font-size:12px; line-height:14px; text-align:left; left:0px; "
            );
            productVariationOptionContainer.appendChild(variationOptionTitle);
            productVariationOptionsContainer.appendChild(
              productVariationOptionContainer
            );
            buyerCartParameters.productVariationUiControl[i] = {
            ...
            awaitVariationSelectionListener(
              "variation-option-container" + uniqueId + i + j,
              ""
            );
          } else if (j > 0) {
        ...
        renderData.productVariations[i].VARIATION_TYPE == "image-text"
      ) {
        ...
        if (renderData.productVariations[i]["options"] != undefined) {
          for (
            ...
            if (j == 0) {
              let cartInfo__id =
                renderData.productVariations[i]["options"][j].ID;
              let cartInfo__title =
                renderData.productVariations[i]["options"][j].TITLE;
              let cartInfo__mediaSource = "";
              cartInfo__mediaSource =
                ...
                renderData.productVariations[i]["options"][j].MEDIA_SOURCE !=
                  null
                  ? (cartInfo__mediaSource =
                      renderData.productVariations[i]["options"][j]
                        .MEDIA_SOURCE)
                  : (cartInfo__mediaSource = "");
              let cartInfo__masterId =
                renderData.productVariations[i]["options"][j]
              ...
              productVariationOptionContainer.setAttribute(
                "style",
                "width:160px; min-height:200px; cursor:pointer; border-radius:6px; box-shadow:0px 0px 0px 3px #000000;   margin-top:10px; margin-left:8px;  margin-right:4px; float:left; "
              );
              productVariationOptionContainer.setAttribute("align", "left");
              productVariationOptionContainer.setAttribute(
                "data-variation_id",
              ...
              let variationAvatarContainer = elementFunction.divFunction(
                "",
                "",
                null
              );
              variationAvatarContainer.setAttribute(
                "style",
                "width:160px; height:140px; float:left; "
              );
              productVariationOptionContainer.appendChild(
                variationAvatarContainer
              );
              //
              let variationAvatar = elementFunction.imgFunction(
                "",
                "",
                renderData.productVariations[i]["options"][j].MEDIA_SOURCE
              );
              variationAvatar.setAttribute(
                "style",
                "width:100%; height:140px; float:left;  border-radius:6px; "
              );
              variationAvatarContainer.appendChild(variationAvatar);
              let variationOptionTitleContainer = elementFunction.divFunction(
                "",
                "",
                null
              );
              variationOptionTitleContainer.setAttribute(
                "style",
                " width:176px; min-height:40px; max-height:auto; float:left; position:absolute;"
              );
              let variationOptionTitle = elementFunction.divFunction(
                "",
                "",
              ...
              variationOptionTitle.setAttribute(
                "style",
                "min-height:40px; max-height:80px; overflow:hidden; width:156px; float:left; border-radius:10px; padding:3px; margin-top:160px; color:#404040; font-family:Montserrat-Regular; font-size:11px; "
              );
              variationOptionTitleContainer.appendChild(variationOptionTitle);
              productVariationOptionContainer.appendChild(
                variationOptionTitleContainer
              );
              buyerCartParameters.productVariationUiControl[i] = {
                elementId: "variation-option-container" + uniqueId + i + j,
              };
              ...
              productVariationOptionContainer.setAttribute(
                "style",
                "width:160px; min-height:200px; cursor:pointer; border-radius:2px; box-shadow:0px 0px 0px 1px #f1f1f1;   margin-top:10px; margin-left:8px;  margin-right:4px; float:left; "
              );
              productVariationOptionContainer.setAttribute("align", "left");
              productVariationOptionContainer.setAttribute(
                "data-variation_id",
              ...
              variationAvatarContainer.setAttribute(
                "style",
                "width:160px; height:140px; float:left;  border-radius:6px; "
              );
              productVariationOptionContainer.appendChild(
                variationAvatarContainer
              );
  ...
  productQuantityLabelContainer.setAttribute(
    "style",
    "width:100%; height:auto; margin-top:20px; float:left;  "
  );
  let productQuantityLabel = elementFunction.divFunction(
    "product-quantity-label" + uniqueId,
    "",
    "Quantity"
  );
  productQuantityLabel.setAttribute("align", "left");
  productQuantityLabel.setAttribute(
    "style",
    "width:90%; max-height:300px; position:relative; font-size:13px; font-family:Montserrat-Medium; color:#000000; left:10px;"
  );
  ...
  let productQuantityContainer = elementFunction.divFunction(
    "product-preview-quantity-container" + mainId,
    "product-preview-quantity-container",
    null
  );
  ...
  controlQuantityButtonHolder.setAttribute(
    "style",
    "width:150px; height:30px; float:left; box-shadow:0px 0px 0px 1px #f1f1f1; position:relative; padding-left:4px; margin-top:18px;  "
  );
  productQuantityContainer.appendChild(controlQuantityButtonHolder);
  let increaseButtonHolder = elementFunction.divFunction(
    "increase-button-holder-" + uniqueId,
    "",
    null
  );
  increaseButtonHolder.setAttribute(
    "style",
    "width:20px; height:30px; float:left; position:relative; cursor:pointer; margin-left:8px;"
  );
  let decreaseButtonHolder = elementFunction.divFunction(
    "decrease-button-holder-" + uniqueId,
    "",
    null
  );
  decreaseButtonHolder.setAttribute(
    "style",
    "width:20px; height:30px; float:left;  position:relative; cursor:pointer; margin-right:8px;"
  );
  let productCartItemQuantity = elementFunction.numberInputFunction(
    "product-cart-item-quantity" + uniqueId,
    "",
    1,
    1
  );
  productCartItemQuantity.setAttribute(
    "style",
    "width:50px; height:30px; float:right; position:relative; background:#ffffff; outline:none; font-family:Montserrat-SemiBold; font-size:13px; text-align:left; padding-left:6px; border:none;   "
  );
  buyerCartParameters.productQuantityId =
    "product-cart-item-quantity" + uniqueId;
  // ::::::::
  let productCartItemPrefix = elementFunction.divFunction("", "", "X");
  productCartItemPrefix.setAttribute(
    "style",
    "width:24px; height:30px; float:left; position:relative; background:#f1f1f1; color:#707070; font-family:Montserrat-SemiBold; line-height:30px; font-size:13px; text-align:center; border:none;   "
  );
  let productCartItemPrefixAndQuantityHolder = elementFunction.divFunction(
    "",
    "",
    null
  );
  productCartItemPrefixAndQuantityHolder.setAttribute(
    "style",
    "width:84px; height:30px; float:left; position:relative; overflow:hidden; background:#f1f1f1; font-family:Montserrat-SemiBold; line-height:30px; font-size:13px; text-align:center; border:none;   "
  );
  ...
  let increaseButtonImage = elementFunction.imgFunction(
    "",
    "",
    "/shorpi/assets/icons/increase-product-icon.png"
  );
  increaseButtonImage.setAttribute(
    "style",
    "width:16px; height:16px; float:left; top:7px; position:relative; cursor:pointer;  "
  );
  let decreaseButtonImage = elementFunction.imgFunction(
    "",
    "",
    "/shorpi/assets/icons/decrease-product-icon.png"
  );
  decreaseButtonImage.setAttribute(
    "style",
    "width:16px; height:16px; float:left; top:7px;  position:relative; cursor:pointer; "
  );
  ...
  controlQuantityButtonHolder.appendChild(
    productCartItemPrefixAndQuantityHolder
  );
  controlQuantityButtonHolder.appendChild(increaseButtonHolder);

  // ::::::::::::::::::::::::::::: action buttons for
  let productActionContainer = elementFunction.divFunction("", "", null);
  productActionContainer.setAttribute(
    "style",
    "width:100%; height:54px; margin-top:20px; float:left;  "
  );
  ...
  productActionButtonContainer.setAttribute(
    "style",
    "width:360px; height:50px; float:left;  "
  );
  productActionContainer.appendChild(productActionButtonContainer);

  let buyNowButton = elementFunction.divFunction(
    "",
    "buy-now-button",
    "Buy Now"
  );
  buyNowButton.setAttribute(
    "style",
    "width:130px; height:34px; position:relative; text-align:center; margin-left:20px; top:10px; border-radius:2px;  font-family:Montserrat-Medium; font-size:12px;  line-height:34px; cursor:pointer; color:#06d6a0; right:10px; box-shadow:0px 0px 0px 1px #f1f1f1; float:left; background:#fafafa; "
  );
  productActionButtonContainer.appendChild(buyNowButton);
  let addToCartButton = elementFunction.divFunction(
    "add-to-cart-button",
    "add-to-cart-button",
    "Add to Cart"
  );
  addToCartButton.setAttribute(
    "style",
    "width:110px; height:34px; position:relative; text-align:center; margin-left:20px; top:10px; border-radius:2px;  font-family:Montserrat-Medium; font-size:12px;  line-height:34px; cursor:pointer; color:#ffffff; right:10px; box-shadow:0px 0px 0px 1px #f1f1f1; float:left;  background:#06d6a0;  "
  );
  productActionButtonContainer.appendChild(addToCartButton);

  // :::::::::::: product more media
  let productMoreMediaContainer = elementFunction.divFunction("", "", null);
  productMoreMediaContainer.setAttribute(
    "style",
    "width:100%; height:auto; margin-top:20px; float:left;  "
  );
  ...
  for (let i = 0; i < renderData.productMoreMedia.length; i++) {
    ...
    avatarContainer.setAttribute(
      "style",
      "width:720px; max-height:720px; float:left; margin-top:10px;"
    );
    let avatar = elementFunction.imgFunction(
      "",
      "",
      renderData.productMoreMedia[i].MEDIA_SOURCE
    );
    avatar.setAttribute(
      "style",
      "max-width:720px; max-height:720px; float:left; margin-top:10px;"
    );
    avatarContainer.appendChild(avatar);
  ...
  awaitCloseProductPreviewListener(
    "close-product-detail-preview" + uniqueId,
    "product-preview-main-container"
  );
};
...
// :::::::::::::
let awaitRemoveProductItem = async (
  clickedId,
  targetElement,
  param1,
  param2,
...
let awaitModifyProductItem = async (
  clickedId,
  targetElement,
  param1,
  param2,
...
let buildProductListItemTemplate = async (
  targetElement,
  param1,
  data,
  param3
  ...
  let mainProductListItemContainer = elementFunction.divFunction(
    "main-product-list-item-container" + mainId,
    "main-product-list-item-container",
    null
  );
  let productSelectCheckContainer = elementFunction.divFunction(
    "product-select-check-container" + mainId,
    "product-select-check-container",
    null
  );
  let productSelectCheck = elementFunction.divFunction(
    "product-select-check" + mainId,
  ...
  // :::
  let productAvatarTitleContainer = elementFunction.divFunction(
    "product-avatar-title-container" + mainId,
    "product-avatar-title-container",
    null
  );
  let productAvatarContainer = elementFunction.divFunction(
    "product-avatar-container" + mainId,
    "product-avatar-container",
    null
  );
  let productAvatar = elementFunction.imgFunction(
    "product-avatar" + mainId,
    "product-avatar",
    data["avatar"]
  );
  ...
  // :::
  let productTitleContainer = elementFunction.divFunction(
    "product-title-container" + mainId,
    "product-title-container",
    null
  );
  let productTitle = elementFunction.divFunction(
    "product-title" + mainId,
    "product-title",
    data["title"]
  );
  let productDescription = elementFunction.divFunction(
    "product-description" + mainId,
    "product-description",
    data["description"]
  );
  productTitleContainer.appendChild(productTitle);
  ...
  mainProductListItemContainer.appendChild(productAvatarTitleContainer);
  // ::
  let productCategoryLabelContainer = elementFunction.divFunction(
    "product-category-label-container" + mainId,
    "product-category-label-container",
    null
  );
  let productCategoryLabel = elementFunction.divFunction(
    "product-category-label" + mainId,
  ...
  // ::
  let productPriceLabelContainer = elementFunction.divFunction(
    "product-price-label-container" + mainId,
    "product-price-label-container",
    null
  );
  let productPriceLabel = elementFunction.divFunction(
    "product-price-label" + mainId,
    "product-price-label",
    data["price"]
  );
  ...
  // ::
  let productStockLabelContainer = elementFunction.divFunction(
    "product-stock-label-container" + mainId,
    "product-stock-label-container",
    null
  );
  let productStockLabel = elementFunction.divFunction(
    "product-stock-label" + mainId,
    "product-stock-label",
    data["stockLeft"] + "/"
  );
  let productStockLabelSpan = elementFunction.spanFunction(
    "product-stock-label-span" + mainId,
  ...
  // ::
  let productBrandLabelContainer = elementFunction.divFunction(
    "product-brand-label-container" + mainId,
    "product-brand-label-container",
    null
  );
  let productBrandLabel = elementFunction.divFunction(
    "product-brand-label" + mainId,
    "product-brand-label",
    data["brand"]
  );
  ...
  // ::
  let productListManageButtonsContainer = elementFunction.divFunction(
    "product-list-manage-buttons-container" + mainId,
    "product-list-manage-buttons-container",
    null
  );
  let productModifyButtonContainer = elementFunction.divFunction(
    "product-modify-button-container" + mainId,
    "product-modify-button-container",
    null
  );
  let productModifyButtonIcon = elementFunction.imgFunction(
    "product-modify-button-icon" + mainId,
    "product-modify-button-icon",
    "/shorpi/assets/icons/modify-product-icon.png"
  );
  let productDeleteButtonContainer = elementFunction.divFunction(
    "product-delete-button-container" + mainId,
    "product-delete-button-container",
    null
  );
  let productDeleteButtonIcon = elementFunction.imgFunction(
    "product-delete-button-icon" + mainId,
    "product-delete-button-icon",
    "/shorpi/assets/icons/delete-icon-button.png"
  );
...
let buildProductCartItem = async (targetElement, mainId, data, viewType) => {
  ...
  data.avatar == ""
    ? (data.avatar = data.productAvatar)
    : (data.avatar = data.avatar);
  let mainProductListItemTarget = document.getElementById(targetElement);
  let mainProductListItemContainer = elementFunction.divFunction(
    "cart-main-product-list-item-container" + mainId,
    "cart-main-product-list-item-container",
    null
  );
  let productSelectCheckContainer = elementFunction.divFunction(
    "cart-product-select-check-container" + mainId,
    "cart-product-select-check-container",
    null
  );
  let productSelectCheck = elementFunction.divFunction(
    "cart-product-select-check" + mainId,
    "cart-product-select-check",
    null
  );
  let shopTitleContainer = elementFunction.divFunction(
    "cart-shop-title-container" + mainId,
  ...
  shopTitleContainer.setAttribute(
    "style",
    "width:100%; height:30px; float:left; box-shadow:0px 0px 0px 1px inset #fbfbfb;  "
  );
  let shopTitle = elementFunction.divFunction(
    "cart-shop-title-container" + mainId,
    "cart-shop-title-container",
  ...
  shopTitle.setAttribute(
    "style",
    "width:200px; height:30px; float:left; text-align:left; line-height:30px; font-family:Montserrat-Medium; font-size:11px;  color:#606060; position:relative; left:10px;  "
  );
  shopTitleContainer.appendChild(shopTitle);
  mainProductListItemContainer.appendChild(shopTitleContainer);
  let cartProductItemVariationContainer = elementFunction.divFunction(
    "cart-product-item-variation-container" + mainId,
    "cart-product-item-variation-container",
    null
  );

  let cartProductContentContainer = elementFunction.divFunction(
    "cart-product-content-container" + mainId,
    "cart-product-content-container",
    null
  );
  cartProductContentContainer.setAttribute(
    "style",
    "width:100%; height:100px; float:left; "
  );
  cartProductItemVariationContainer.setAttribute(
    "style",
    "width:100%; height:40px; float:left;  "
  );
  let selectCheckImage = elementFunction.imgFunction(
    "",
    "",
    "/shorpi/assets/icons/check-cart-product.png"
  );
  selectCheckImage.setAttribute(
    "style",
    "width:14px; height:14px; float:left; top:1px; left:2px; position:relative; cursor:pointer;  "
  );
  ...
  // :::
  let productAvatarTitleContainer = elementFunction.divFunction(
    "cart-product-avatar-title-container" + mainId,
    "cart-product-avatar-title-container",
    null
  );
  let productAvatarContainer = elementFunction.divFunction(
    "cart-product-avatar-container" + mainId,
    "cart-product-avatar-container",
    null
  );
  let productAvatar = elementFunction.imgFunction(
    "cart-product-avatar" + mainId,
    "cart-product-avatar",
    data["avatar"]
  );
  productAvatarTitleContainer.appendChild(productAvatarContainer);
  ...
  // :::
  let productTitleContainer = elementFunction.divFunction(
    "cart-product-title-container" + mainId,
    "cart-product-title-container",
    null
  );
  let productTitle = elementFunction.divFunction(
    "cart-product-title" + mainId,
    "cart-product-title",
    cutString(data["title"], 0, 0, 30)
  );
  let productDescription = elementFunction.divFunction(
    "cart-product-description" + mainId,
    "cart-product-description",
    cutString(data["description"], 0, 0, 95)
  );
  productTitleContainer.appendChild(productTitle);
  productTitleContainer.appendChild(productDescription);
  productAvatarTitleContainer.appendChild(productTitleContainer);
  cartProductContentContainer.appendChild(productAvatarTitleContainer);
  let productQuantityContainer = elementFunction.divFunction(
    "cart-product-quantity-container" + mainId,
  ...
  controlQuantityButtonHolder.setAttribute(
    "style",
    "width:150px; height:30px; float:left; box-shadow:0px 0px 0px 1px #f1f1f1; position:relative; left:10px; padding-left:4px; margin-top:18px;  "
  );
  productQuantityContainer.appendChild(controlQuantityButtonHolder);
  ...
  productCartItemQuantity.setAttribute(
    "style",
    "width:40px; height:30px; float:right; position:relative; background:#ffffff; outline:none; font-family:Montserrat-SemiBold; font-size:13px; text-align:left; padding-left:6px; border:none;   "
  );
  let productCartItemPrefix = elementFunction.divFunction("", "", "X");
  productCartItemPrefix.setAttribute(
    "style",
  ...
  // ::
  let productPriceLabelContainer = elementFunction.divFunction(
    "cart-product-price-label-container" + mainId,
    "cart-product-price-label-container",
    null
  );
  let productCurrencyLabel = elementFunction.divFunction(
    "cart-product-currency-label" + mainId,
    "cart-product-currency-label",
    "$"
  );
  //productPriceLabelContainer.appendChild(productCurrencyLabel)
  let productPriceLabel = elementFunction.divFunction(
    "cart-product-price-label" + mainId,
    "cart-product-price-label",
    addCommas(data["price"])
  );
  //productPriceLabelContainer.appendChild(productPriceLabel)
  ...
  let productActionContainer = elementFunction.divFunction(
    "cart-product-remove-container" + mainId,
    "cart-product-remove-container",
    null
  );
  //let productPriceLabel = elementFunction.divFunction("cart-product-price-label" + mainId, "cart-product-price-label", data['price'])
  //productPriceLabelContainer.appendChild(productPriceLabel)
  ...
  let removeCartItemButtonImage = elementFunction.imgFunction(
    "",
    "",
    "/shorpi/assets/icons/remove-from-cart-icon.png"
  );
  removeCartItemButtonImage.setAttribute(
    "style",
    "width:16px; height:16px; float:left; top:24px; left:10px; position:relative; cursor:pointer; "
  );
  ...
  let variationTextOptionsContainer = elementFunction.divFunction(
    "variation-text-option-container" + mainId,
    "variation-text-option-container",
    null
  );
  ...
  try {
    if (Object.keys(cartProductVariation).length > 0) {
      variationTextOptionsContainer.setAttribute(
        "style",
        "width:80%; height:auto; float:left; background:#fbfbfb; padding-top:6px; padding-bottom:6px; padding-left:6px; padding-right:6px; top:0px; left:40px; position:relative;  "
      );
      for (let v = 0; v < Object.keys(cartProductVariation).length; v++) {
        console.log(
          cartProductVariation[Object.keys(cartProductVariation)[v]]["title"]
        );
        let variation_ = elementFunction.divFunction(
          "variation-option-title" + mainId,
          "variation-option-title",
          cartProductVariation[Object.keys(cartProductVariation)[v]]["title"] +
            " ;"
        );
        variation_.setAttribute(
          "style",
          "font-family:Montserrat-SemiBold; cursor:pointer; float:left; margin-right:10px; color:#606060; font-size:11px; position:relative;  "
        );
...
// ::::::::::::: buyer search result
let buildProductSearchResultTemplate = async (
  mainContainer,
  mainId,
  renderData,
  viewType
  ...
  // ::::::: id, class, content
  let previewProductDetailsContainer = elementFunction.divFunction(
    "product-preview-details-container" + mainId,
  ...
  previewProductDetailsContainer.setAttribute(
    "style",
    "width:160px; height:280px; cursor:pointer;  margin-top:10px; margin-left:8px;  margin-right:4px; float:left; "
  );
  let productAvatarContainer = elementFunction.divFunction(
    "product-avatar-container",
    "",
  ...
  productAvatarContainer.setAttribute(
    "style",
  ...
  productAvatar.setAttribute(
    "style",
    " width:100%; height:150px; float:left; "
  );
  let productDetailsContainer = elementFunction.divFunction(
    "product-details-container",
    "product-details-container",
    ""
  );
  productDetailsContainer.setAttribute("align", "left");
  productDetailsContainer.setAttribute(
    "style",
    " width:176px; height:180px; float:left; position:absolute;  "
  );
  let productTitle = elementFunction.divFunction(
    "product-title",
    "",
  ...
  productTitle.setAttribute(
    "style",
    " height:auto; width:156px; float:left; border-radius:10px; font-size:14px; padding:3px; margin-top:160px; color:#404040; font-size:11px; font-family:Montserrat-Regular; font-size:11px; "
  );
  let productPrice = elementFunction.divFunction("product-price", "", "");
  productPrice.setAttribute(
    "style",
    "height:24px; width:100%; float:left; border-radius:10px;  padding:3px; margin-top:2px; color:#000000;  font-family:Montserrat-SemiBold; font-size:16px; "
  );
  let productPriceSign = elementFunction.spanFunction(
    "product-price-sign",
    "",
    "$"
  );
  let productPercentReduction = elementFunction.spanFunction(
    "percent-reduction",
    "",
    "-" + percentReduction + "%"
  );
  productPercentReduction.setAttribute(
    "style",
    "width:40px; height:30px; border-radius:4px; font-size:10px; letter-spacing:0.0016em; background:#fff1e6; font-family:Montserrat-Regular;  position:relative; left:6px; padding-top:1px; padding-bottom:1px; top:-2px; padding-left:6px; padding-right:6px; line-height:30px;  "
  );

  let canceledProductPrice = elementFunction.divFunction(
    "product-price",
    "",
    ""
  );
  canceledProductPrice.setAttribute(
    "style",
    "height:20px; width:100%; float:left; border-radius:10px; font-size:11px; text-decoration: line-through; padding:3px; margin-top:0px; color:#404040; font-family:Montserrat-SemiBold;  "
  );
  let canceledProductPriceSign = elementFunction.spanFunction(
    "product-price-sign",
    "",
    "$"
  );
  canceledProductPriceSign.setAttribute(
    "style",
    "font-size:11px; font-family:Montserrat-Regular; text-decoration:none; margin-right:0.4px; "
  );

  let productsSoldContainer = elementFunction.divFunction(
    "product-price",
    "",
    ""
  );
  productsSoldContainer.setAttribute(
    "style",
    "height:20px; width:100%; float:left; border-radius:10px; font-size:11px; padding:3px; margin-top:0px; color:#000000; opacity:0.8; font-family:Montserrat-SemiBold;  "
  );
  let productsSold = elementFunction.spanFunction(
    "product-price-sign",
    "",
    "124 sold"
  );
  productsSold.setAttribute(
    "style",
    "font-size:10px; font-family:Montserrat-Medium; margin-right:0.4px; border-radius:4px; background:#d8f3dc; padding-top:2px; padding-bottom:2px; top:-2px; padding-left:6px; padding-right:6px; "
  );
  productsSoldContainer.appendChild(productsSold);

  productPriceSign.setAttribute(
    "style",
    "font-size:11px; font-family:Montserrat-Regular; margin-right:0.4px; "
  );
  ...
  $(productPrice).html(
    productPrice.innerHTML + " " + addCommas(renderData.price)
  );
