...
let mapLoad= setInterval(function(){
    ...
    if(userLocation.latitude!=0 && document.getElementById('map-order-location')!==null){


        var mymap = L.map("map-order-location").setView([ userLocation.latitude,  userLocation.longitude ], 13);
