<template>
  <header class="fixed top-0 left-0 right-0 bg-white/95 backdrop-blur-sm z-[100] transition-all duration-300">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25h16.5" />
      ...
      >
        ...
        <!-- Menu Content -->
        <div 
          class="fixed left-0 top-0 w-80 bg-white h-full overflow-y-auto transform transition-transform duration-300"
            ...
            <div class="space-y-6 mt-12">
              <div v-for="item in menuItemsWithCollections" :key="item.id">
                ...
                <div 
                  ...
                  class="pl-4 mt-2 space-y-3 overflow-hidden transition-all duration-300"
                >
                  <router-link 
