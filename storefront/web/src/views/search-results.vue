...
-->
                ...
                <div style="font-family:Nunito-Medium; "
                    ...
                    <div class="flex mt-8 mb-0 justify-between text-sm font-medium text-gray-700">
                        <p class="font-normal ">Search results for </p>
                    ...
                    <div class="flex mt-2 mb-6 justify-between text-base font-medium text-gray-900">
                        <p class="font-bold ">shoes(1572)</p>
...
import ResultItems from "../vnav-widgets/result-items.vue"
