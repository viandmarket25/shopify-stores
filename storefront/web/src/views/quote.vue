<template>
      ...
      <div class="overflow-hidden">
        <div class="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div class="relative mx-auto max-w-4xl grid space-y-5 sm:space-y-10">
            ...
            <div v-if="!quoteSubmitted" class="text-center">
              <h1 v-if="content" class="text-3xl font-bold text-gray-800 sm:text-4xl ">
                {{ content.qtGet }}
              </h1>
              <p v-if="content" class="mt-1 text-gray-600 ">
                {{ content.cntWh }}
              </p>
            </div>

            <div v-if="quoteError"
                class="bg-yellow-50 border mb-4 border-yellow-200 text-sm text-yellow-800 rounded-lg p-4 "
                role="alert">
                <div class="flex">
                  ...
                  <div class="ms-4">
                    <h3 class="text-sm font-semibold">
                      Cannot Request Quote  🙀
                    </h3>
                    <div class="mt-1 text-sm text-yellow-700">
                      Enter required details, make sure email is valid
                    </div>
                  </div>
            ...
            <form v-if="!quoteSubmitted">
              ...
              <div
                ...
                <div class="pb-2 sm:pb-0 sm:flex-[1_0_0%]">
                  <label for="hs-hero-name-1" class="block text-sm font-medium "><span class="sr-only">Full
                      name</span></label>
                  <input style="box-shadow: 0 0 0 1 #f1f1f1;"  maxlength="35" v-model="fullName" type="text" id="hs-hero-name-1"
                    class="border py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 "
                    placeholder="Full name">
                </div>
                <div class="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] ">
                  <label for="hs-hero-email-1" class="block text-sm font-medium "><span
                      class="sr-only">Email address</span></label>
                  <input v-model="email" type="email" maxlength="35" id="hs-hero-email-1"
                    class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 "
                    placeholder="Email">
                </div>
                <div class="pt-2 sm:pt-0 sm:pl-3 border-t border-gray-200 sm:border-t-0 sm:border-l sm:flex-[1_0_0%] ">
                  <label for="hs-hero-name-1" class="block text-sm font-medium "><span
                      class="sr-only">Phone</span></label>
                  <input v-model="phone" maxlength="15" type="text" id="hs-hero-name-1"
                    class="py-3 px-4 block w-full border-transparent rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 sm:p-4 "
                    placeholder="Phone">
                </div>
              ...
              <div
                ...
                <textarea v-model="shippingDestination" maxlength="335"
                  class="py-1 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 "
                  rows="3" placeholder="Shipping Destination"></textarea>
              ...
              <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white  rounded-lg ">
                <label for="textarea-label"
                  class="block text-sm font-medium mb-2 ">{{ content.qtDYH }}</label>
              ...
              <div
                ...
                <img v-if="imagePreview != null" style="max-height:100px; " :src="imagePreview" class="uploading-image" />

                <input @change="handleImageChange" accept="image/*" type="file" name="file-input" id="file-input" class="block w-full border border-gray-200 shadow-sm rounded-lg text-sm focus:z-10 focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none 
  ...
  ">
              ...
              <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3 bg-white  rounded-lg ">
                ...
                <label for="textarea-label"
                  class="block text-sm font-medium mb-2 ">{{ content.qtSQ }}</label>
                  ...
                  <div class="w-full flex justify-between items-center gap-x-5">
                    ...
                    <div class="grow">
                      <input v-model="quantity"
                        class="p-1 w-full p-0 bg-transparent border-0 text-gray-800 focus:ring-0 "
                        type="number" placeholder="0.00" data-hs-input-number-input>
                    </div>
              ...
              <div
                ...
                <textarea v-model="productDetails" maxlength="335"
                  class="py-3 px-4 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 "
                  rows="3" placeholder="Please describe the type of product you are looking for"></textarea>
              ...
              <div
                ...
                <select v-model="productCategory" id="hs-select-label"
                  class="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 ">
                  <option selected>What type products are you looking for?</option>

                  <option value="Food and Beverages">Food and Beverages</option>
                  <option value="Electronics">Electronics</option>
                  <option value="Automobiles & Heavy Machines">Automobiles & Heavy Machines</option>
                  <option value="Fashion & Clothing">Fashion & Clothing</option>
                  <option value="Computers ( Hardware & Software)">Computers ( Hardware & Software)</option>
              ...
              <div
                ...
                <select v-model="businessSize" id="hs-select-label"
                  class="py-3 px-4 pr-9 block w-full border-gray-200 rounded-md text-sm focus:border-blue-500 focus:ring-blue-500 ">
                  <option selected>How best do you describe your business size?</option>
                  <option>Startup</option>
                  <option>Small Business</option>
                  <option>Medium Scale Business</option>
                  <option>Large Scale Business</option>
              ...
              <div class="mx-auto max-w-2xl sm:flex sm:space-x-3 p-3  rounded-lg shadow-lg shadow-gray-100 ">


                <p class="text-sm text-gray-500 mt-2" id="hs-input-helper-text">{{ content.qtWSD }}.</p>

                <br />
                <div stylle="border-radius:0px;" @click="addQuote()"
                  class=" pt-2 sm:pt-0 grid sm:block sm:flex-[0_0_auto]">
                  <span style="background:#202020; height:38px; cursor:pointer; "
                    class="py-3 px-4 inline-flex justify-center items-center gap-2 rounded-2xl border border-transparent font-semibold bg-blue-500 text-white hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 transition-all text-sm sm:p-4 "
                    href="#">

                    <span v-if="awaitingResponse"
                      class="animate-spin inline-block w-4 h-4 border-[3px] border-current border-t-transparent text-grey-200 rounded-full "
            ...
            <div v-if="quoteSubmitted" class="flex p-4 items-center justify-center ">
              <div class="rounded-lg bg-gray-50 px-16 py-14">
                <div class="flex justify-center">
                  <div class="rounded-full bg-purple-200 p-6">
                    <div class="flex h-16 w-16 items-center justify-center rounded-full bg-purple-500 p-4">
                ...
                <h3 class="my-4 text-center text-2xl font-semibold text-gray-700">Congratulations!</h3>
                <p class="w-[230px] text-center font-normal text-gray-600">Your quote request has been submitted</p>
      ...
      -->
            ...
            <div
              ...
              <div class="w-72 h-auto"
                style="height:100px; width:100px; background-image: linear-gradient(120deg, #e0c3fc 0%, #8ec5fc 100%);">
              </div>
...
export default {
  ...
  async created() {
    ...
    await visitorService.addVisitorByIp(1, '/blogs' )
  ...
  methods: {
    ...
    checkFieldValidity(valueField) {

      // Value emptiness validation
      const isValueEmpty = valueField.trim() === "";
    ...
    async addQuote() {
      ...
      formData.append('shippingDestination', this.shippingDestination);
      formData.append('businessSize', this.businessSize);
      formData.append('productCategory', this.productCategory);

      if (this.image !== null) {
        formData.append('image', this.image);
        formData.append('imageUploaded', true);

      }else{
        formData.append('imageUploaded', false);


      }

      if(  this.checkFieldValidity(this.fullName)  &&  this.checkFieldValidity(this.productDetails)  &&  this.checkEmailValidity( this.email)  ){

        this.awaitingResponse=true
        let quoteResponse = await quoteService.addQuote(formData)

        if (quoteResponse.resultCode == 1) {
          //alert()
